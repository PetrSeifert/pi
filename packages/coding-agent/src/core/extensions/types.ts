...
export interface ExtensionAPI {
	...
	/** Execute an extension slash command programmatically without sending it to the agent. */
...
export type RunCommandHandler = (command: string, options?: { waitForIdle?: boolean }) => void;
